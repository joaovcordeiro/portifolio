...
export default function HireMe() {
    return (<div className="fixed left-4 bottom-4 flex items-center justify-center overflow-hidden z-10 sm:z-0
    ...
    ">
        <div className="w-48 h-auto flex items-center justify-center md:w-24">
            ...
            <Link href="https://wa.me/+5586999365216" target="_blank" className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 
