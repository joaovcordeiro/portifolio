...
export default function HireMe() {
    ...
    " >
        <div className="w-48 h-auto flex items-center justify-center md:w-24">
            ...
            <Link href="https://wa.me/+5586999365216" aria-label="Botão de acesso para conversa por whatsapp." target="_blank" className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 
