...
export default function Footer() {
    return (
        <footer className="w-full border-t-2 border-solid border-colors-light font-medium text-sm bg-colors-dark text-colors-light md:text-xs">
            <Layout className="py-8 flex items-center justify-between !bg-colors-dark lg:py-6">
